...
def get_row(driver: webdriver, d: int) -> list:
    url = f"https://pvoutput.org/intraday.jsp?id=92428&sid=81697&dt={year}{str(month).zfill(2)}{str(day).zfill(2)}&gs=0&m=0"
    subtract_day()
...
if __name__ == "__main__":
    ...
    options = Options()
    options.add_argument("-private")  # Enables Private Browsing (Guest Mode)
