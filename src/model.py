...
def test_model():
    ...
    predicted_data = pd.DataFrame({
        'DateTime': dates[:len(dates) - smoothing_step],  # Use the corresponding DateTime
        'Actual': smooth_actual,  # Smoothed actual data
        'Predicted': smooth_pred  # Smoothed predicted data
    })

    # Save the DataFrame to a CSV file
    predicted_data.to_csv('./out/predicted_data.csv', index=False)
